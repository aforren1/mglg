...
import moderngl
import glfw
from imgui.integrations.glfw import GlfwRenderer as GlfwRenderOld


class ModernglRenderer(object):
    # lifted directly from moderngl-window
    # https://github.com/moderngl/moderngl-window/blob/master/moderngl_window/integrations/imgui.py
...
class MyRenderer(ModernglRenderer, GlfwRenderOld):
    def __init__(self, *args, **kwargs):
        ModernglRenderer.__init__(self, *args, **kwargs)
        self.window = kwargs.get('wnd')._win
...
if __name__ == '__main__':
    ...
    from mglg.graphics.gui import MyRenderer
    imgui.create_context()

    impl = MyRenderer(wnd=win)
